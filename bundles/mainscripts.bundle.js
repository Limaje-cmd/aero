function skinChanger() {
    ...
    $(".right-sidebar .bg_color li").on("click", function() {
        ...
        $(".right-sidebar .bg_color li").removeClass("active"),
        a.removeClass("bbg-" + c),
        b.addClass("active"),
...
function CustomJs() {
	...
	$(".rv-btn-toggle").on("click", function() {
		$("body").toggleClass("ls-closed right_icon_toggle")
    })
}
...
$.AdminAero.leftSideBar = {
    activate: function() {
        ...
        $(window).on("click", function(d) {
            ...
            !e.hasClass("bars") && a.isOpen() && 0 === e.parents("#leftsidebar").length && (e.hasClass("js-right-sidebar") || c.fadeOut(),
        ...
        $(".menu-toggle").on("click", function(a) {
            ...
            if ($(b.parents("ul")[0]).hasClass("list")) {
                ...
                $.each($(".menu-toggle.toggled").not(d).next(), function(a, b) {
                    $(b).is(":visible") && ($(b).prev().toggleClass("toggled"),
                    $(b).slideUp())
                })
            }
    ...
    checkStatuForResize: function(a) {
        ...
        d < 1170 ? (d > 767 && b.addClass("ls-toggle-menu"),
        b.addClass("ls-closed"),
        c.fadeIn()) : (b.removeClass("ls-closed ls-toggle-menu"),
        c.fadeOut())
    },
    isOpen: function() {
...
$.AdminAero.rightSideBar = {
    activate: function() {
        ...
        $(window).on("click", function(d) {
            var e = $(d.target);
            "i" === d.target.nodeName.toLowerCase() && (e = $(d.target).parent()),
            !e.hasClass("js-right-sidebar") && a.isOpen() && 0 === e.parents("#rightsidebar").length && (e.hasClass("bars") || c.fadeOut(),
            b.removeClass("open"))
        }),
        $(".js-right-sidebar").on("click", function() {
            b.toggleClass("open"),
            a.isOpen() ? c.fadeIn() : c.fadeOut()
        })
    },
    isOpen: function() {
...
$.AdminAero.navbar = {
    activate: function() {
        ...
        $(".bars").on("click", function() {
            a.toggleClass("overlay-open"),
            a.hasClass("overlay-open") ? b.fadeIn() : b.fadeOut()
        }),
...
$(function() {
    "#dark" == location.hash && ($("body").addClass("theme-dark"),
